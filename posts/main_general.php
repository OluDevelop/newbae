<div class="feed">
                            ...
                            <div class="feed-head">
                                ...
                                <div onclick="post_Id('<?php echo $post_id?>', '<?php echo $user_id ?>', '<?php echo $session_id ?>', '<?php echo $fetch_post['post_text'] ?>')" class="postMoreOption"><span class="material-icons-sharp">more_horiz</span></div>
